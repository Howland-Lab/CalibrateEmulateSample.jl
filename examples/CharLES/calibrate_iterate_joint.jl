...
if constrain == true
    physical_params_success = comp2phys_transform(params_success, prior_lower, prior_upper);
else
...
if iteration < N_iter
    if constrain == true
        new_physical_params = comp2phys_transform(get_u_final(ekiobj), prior_lower, prior_upper);
    else
    ...
    elseif avg == "txz2"
        scratch_dir = "/home/ctrsp-2024/mjchan/joint_charles_data_txz2";
    end
