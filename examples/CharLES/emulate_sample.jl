...
function main()
    ...
    for (case) in cases[mask]
        ...
        # Should be loaded:
        z0_true = 0.1   # reference 'truth' roughness length
        ...
        nugget = 0.001
        if case == "GP"
            gppackage = Emulators.GPJL()     # or use Emulators.SKLJL() (found this to work better)
        ...
        standardize = false               # this normalizes outputs (requires norm factor)
