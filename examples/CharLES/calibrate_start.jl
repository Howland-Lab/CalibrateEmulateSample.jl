...
z0_true = 1000 * 6.8E-5;      # prescribed roughness length for perfect model 
...
###
perfect = false;      # Perfect vs imperfect model setting
data_path = @__DIR__
if perfect
    ...
    yt = CSV.File(yt_csv; header=false); yt = DataFrame(yt); yt = Matrix(yt); yt =yt';
    yt = yt[points_mask,:];
end
