...
include(joinpath(@__DIR__, "gmodel", "gmodel_z0zd.jl"))
...
function main()
    ...
    if avg == "t"
        data_save_directory = homedir * "/run_t_z0zd/"
    elseif avg == "tz"
        data_save_directory = homedir * "/run_tz_z0zd/"
    elseif avg == "txz"
        data_save_directory = homedir * "/run_txz_z0zd/"
    end
    ...
    prior_lower = [0, 0]   # first index is dummy value
    prior_upper = [0, 8.0]
